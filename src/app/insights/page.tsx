...
export const metadata: Metadata = {
  title: "Insights",
  description: "Thinking on SEO, GEO, founder authority and narrative infrastructure.",
};
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <Reveal delay={0.1} className="mt-16 rounded-2xl border border-dashed border-navy/15 p-16 text-center">
            <p className="text-lg text-gray-dark">
              ...
              <a href="/seo-geo" className="text-royal underline">
                SEO + GEO
              </a>{" "}
              or{" "}
              <a href="/the-system" className="text-royal underline">
                The System
              </a>
              .
            </p>
