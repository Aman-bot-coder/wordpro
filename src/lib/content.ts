...
export const authorityStack = [
  ...
  },
  {
    ...
    body: "The IP layer is then deployed across every discovery layer, through content that compounds instead of becoming irrelevant over time.",
  },
];
...
// Pricing page — verbatim from the Wrds.Pro "Pricing" doc.
export const pricingDoc = {
  hero: {
    title: "Clear Wrds.Pro Pricing Plans, Built Around LinkedIn",
    body: "Every Wrds.Pro pricing plan begins with LinkedIn, and search and AI visibility are added to it. The difference in these plans lies in what we deliver and the kind of strategy we follow for your brand.",
  },
  plans: [
    {
      id: "foundation",
      ...
      features: [
        "4 LinkedIn posts each month",
        "2 LinkedIn articles each month",
        "4 SEO articles each month",
        "Writing and editorial support",
        "On-page search optimization",
        "Baseline GEO structuring, so your content is built to be understood by search engines and cited by AI search tools from day one",
        "One revision round",
        "Initial strategy session",
      ],
      note: "Ten pieces a month, building a content library that works for years.",
      idealFor: "Businesses testing the approach",
      cta: { label: "Book Your Authority Audit", href: "/contact" },
    },
    {
      id: "growth",
      name: "GROWTH",
      ...
      leadNote: null as string | null,
      features: [
        "6 LinkedIn posts and 2 long-form articles each month",
        "Up to 8 search-led content pieces",
        "Keyword, competitive, and market analysis",
        "Content briefs and editorial planning",
        "Full metadata, linking and schema",
        "AEO and GEO for AI search visibility",
        "Two revision rounds and a monthly review",
      ],
      note: "Where we start taking responsibility for direction.",
      idealFor: "Businesses that know their position",
      cta: { label: "Book Your Authority Audit", href: "/contact" },
    },
    {
      id: "authority",
      ...
      tagline: "The full programme, website included",
      tag: null as string | null,
      highlight: true,
      lead: "Website build worth $4,500 at no charge",
      leadNote: "Everything in Growth plan, plus:",
      features: [
        "8 LinkedIn posts and 4 long-form articles each month",
        "10+ search-led content, fair use",
        "Off-page authority and backlink development",
        "Twenty-question AI panel, reported monthly",
        "Executive brand and thought-leadership sessions, built through our Executive Authority Stack: Signal Audit, IP Engine, and Intellectual Asset Class",
        "LinkedIn strategy and competitive monitoring",
        "Unlimited revisions within the agreed scope, with calls every two weeks",
      ],
      note: null as string | null,
      idealFor: "Businesses ready to lead their field",
      cta: { label: "Talk to us", href: "/contact" },
    },
  ],
  addOns: {
    title: "Add-ons",
    body: "Available with any plan. Quoted on request, based on your scope.",
    items: [
      { k: "Website development", v: "New builds and rebuilds, designed to load fast and perform in search" },
      { k: "Social media", v: "Content for Instagram, Facebook and X" },
      { k: "Reddit", v: "Genuine participation in the communities your buyers trust" },
      { k: "Paid advertising", v: "Campaign management on Google and social platforms, with ad spend billed separately" },
    ],
  ...
  everyPlan: {
    ...
    items: [
      { k: "Human-written content.", v: "Every piece is written by our team, not generated by AI." },
      { k: "You own the work.", v: "All intellectual property transfers to you on payment." },
      { k: "Honest reporting.", v: "We tell you what we delivered and what it did, without inflated numbers." },
    ],
  },
  terms: {
    title: "Terms",
    body: "Six-month minimum term, then month-to-month with 30 days' written notice.",
  },
  faqs: [
    { q: "Can I change plans later?", a: "Yes. You can move up at any time. Moving down takes effect after your minimum term." },
    { q: "Do prices include ad spend?", a: "No. Paid advertising is quoted separately, and your ad spend is billed directly." },
    { q: "Can I buy just one service?", a: "Yes. Talk to us about what you need, and we'll quote it." },
  ],
  notSure: {
    title: "Not sure which plan fits?",
    body: "Tell us what you do and where you want to be visible. We'll recommend a plan, or tell you honestly if you don't need one yet.",
    email: "neha@wrds.pro",
  },
};
...
export const capacity = "Only 8 founders are accepted per quarter, as a rule. The limitation exists so every engagement gets a senior strategist's time and a dedicated senior human writer.";
...
// ---------------------------------------------------------------------------
// The System page — source: wrds.pro "The System" doc.
// ---------------------------------------------------------------------------
